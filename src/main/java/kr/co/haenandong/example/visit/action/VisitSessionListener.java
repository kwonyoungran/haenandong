 ...
 *
 */
package kr.co.haenandong.example.visit.action;

import javax.servlet.http.HttpSession;
import javax.servlet.http.HttpSessionEvent;
import javax.servlet.http.HttpSessionListener;

import kr.co.haenandong.example.visit.model.VisitCountDAO;

/**
 * 방문자 수를 계산하는 클래스<br>
 * web.xml에 listener 등록을 해두었다. 이렇게 할 경우 톰캣이 실행되면서 리스너가 실행된다.
 */
